        ...
        <div style={{ minWidth: 500, height: '100%' }}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart layout="vertical" data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}
              ...
              <YAxis type="category" dataKey="name" width={115} tick={<CustomYAxisTick />} />
              <Tooltip content={(props) => <GlassTooltip {...props} direction="left" labelKey="name" />} cursor={{ fill: 'rgba(0,0,0,0.04)' }} />
              {showRefLines && <>
